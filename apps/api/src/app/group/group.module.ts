...
import { APPLICATION_SERVICES, COMMAND_HANDLERS } from '@api/group/application'
...
@Module({
    ...
    providers: [...APPLICATION_SERVICES, ...COMMAND_HANDLERS, { provide: GroupRepository, useClass: MongoGroupRepository }]
})
